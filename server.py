...
def get_ev_makes_data():
    ...
    with open('data/ev.json') as f:
        ...
        # all_makes = []
        # for ev in ev_data:
        #     ev_make = ev["manufacturer_name"]
        #     all_makes.append(ev_make)
...
#     res = request.get('https://developer.nrel.gov/docs/transportation/alt-fuel-stations-v1.json/', 
#                     params=payload)
